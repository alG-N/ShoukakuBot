# Type Declaration Scan (2026-03-04, post Phase 16 - fully deduplicated)

- Scope: `src/**/*.ts`
- Files with declarations: 144
- Total `type`: 88
- Total `interface`: 516
- Total `enum`: 2
...
|---|---:|---:|---:|---:|
| src/services/api/myAnimeListService.ts | 1 | 34 | 0 | 35 |
...
| src/handlers/api/animeHandler.ts | 2 | 9 | 0 | 11 |
...
| src/commands/api/anime.ts | 2 | 6 | 0 | 8 |
| src/commands/api/pixiv.ts | 1 | 7 | 0 | 8 |
| src/commands/api/rule34.ts | 5 | 3 | 0 | 8 |
| src/handlers/api/nhentaiHandler.ts | 4 | 4 | 0 | 8 |
